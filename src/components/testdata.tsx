export const testData = [
  ...
  unit: 4191,
  show_id: 70254840,
  show_title: "Headhunter",
  release_year: "2005",
  rating: "2.7",
  category: "Horror Movies",
  show_cast: "Mark Aiken, Kristi Clainos, Joseph Alfieri, René Ashton, Timothy Thomas Brown, Matt Bushell, Krista Carpenter, Benjamin John Parrillo, Rick Schiaffo, Lindsey Stoddart",
  director: "Paul Tarantino",
  summary: "An ambitious young go-getter works a graveyard shift to get ahead. He also accepts the advances of his sexy employer, only to learn that his real job is to find a missing head or lose his own!",
  poster: "http://netflixroulette.net/api/posters/70254840.jpg",
  mediatype: 0,
  runtime: "108 min"
  },
  {
  unit: 8351,
  show_id: 70305921,
  show_title: "When Aliens Attack",
  release_year: "2011",
  rating: "3.0",
  category: "TV Shows",
  show_cast: "James Lurie, Nick Pope, Paul Springer",
  director: "Louis Tarantino",
  summary: "Scientists and experts on defense and survival discuss how an extraterrestrial attack on Earth might unfold, and what might prompt such an invasion.",
  poster: "http://netflixroulette.net/api/posters/70305921.jpg",
  mediatype: 0,
  runtime: "N/A"
  },
  {
